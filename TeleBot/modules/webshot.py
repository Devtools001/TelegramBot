...
from TeleBot import aiohttpsession as session
...
@pgram.on_message(filters.command(["webss", "ss", "webshot"]))
...
「𝗖𝗢𝗠𝗠𝗔𝗡𝗗𝗦」 :
═───────◇───────═
๏ /webss | /ss | /webshot : sᴇɴᴅs ᴛʜᴇ sᴄʀᴇᴇɴsʜᴏᴛ ᴏғ ᴛʜᴇ ɢɪᴠᴇɴ ᴜʀʟ.
═───────◇───────═
"""
__mod_name__ = "𝚆ᴇʙsʜᴏᴛ"
